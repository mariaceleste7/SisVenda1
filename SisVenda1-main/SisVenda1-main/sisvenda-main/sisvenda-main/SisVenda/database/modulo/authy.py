#código para fazer autenticação de login e senha
import bcrypt
import sqlite3
import sys
...
def verificar_senha(senha_texto_puro: str, senha_hash: str) -> bool:
    ...
    return bcrypt.checkpw(senha_texto_puro.encode('utf-8'),
                          senha_hash.encode('utf-8'))

def criar_usuario_admin_padrao():
    """Cria o administrador inicial ('admin' / 'admin123') se o banco estiver
    vazio."""
    conn = get_connection()
    cursor = conn.cursor()
